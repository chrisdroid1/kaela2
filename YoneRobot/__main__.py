...
PM_START_TEXT = """
ʜᴇʟʟᴏ [🤗](https://telegra.ph/file/007b0c4d312abfe83e43a.jpg), ɪᴍ ʏᴏɴᴇ ᴀ ʜɪɢʜʏ ᴀᴅᴠᴀɴᴄᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ʟᴏᴛꜱ ᴏꜰ ᴀᴍᴀᴢɪɴɢ ᴛᴏᴏʟꜱ.
`IM AKIRO AND IM HERE TO HELP YOU MANAGE YOUR GROUP! HIT` /help   
"""

buttons = [
    [
        InlineKeyboardButton(
            text="➕️🌹 ADD Akiro TO YOUR GROUP🌹 ➕️", url="t.me/Akirogrpbot?startgroup=true"),
    ],
    [
...
HELP_STRINGS = """
`hello...I’m` [Akiro🙋‍♀️](https://telegra.ph/file/4cb5ca30ce7435b8f1039.jpg) 
`Click on the Button below To get Documentation About Specific Module..`"""

yone_IMG = "https://telegra.ph/file/491cc72e8d0697485a783.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project via [Paypal](#) or by contacting @Mrkahno \
            ...
            if args[0].lower() == "help":
                ...
                send_help(
                    ...
                    InlineKeyboardMarkup(
                        [[InlineKeyboardButton(text="👈 Exit", callback_data="help_back")]]
                    ),
                )
...
def yone_about_callback(update, context):
    ...
    if query.data == "yone_":
        query.message.edit_text(
            text=""" ℹ️ I'm *🌹Akiro🌹*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \nHere is the [Creator](https://t.me/Mrkahno).
